...
El aviso pospuesto usa el id `agenda-p-…`. Un **resync** al volver a la app **no** lo cancela; al **guardar cambios** en el evento sí se cancelan todas las notificaciones de ese evento (incluido el pospuesto), para no dejar alarmas obsoletas.
...
## Botones en la notificación (Ok / Eliminar / Posponer)
